            ...
            <div className="col-lg-8">
              ...
              <form>
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 mb-4">
                    <div data-mdb-input-init className="form-outline">
                      <input type="text" id="form3Example7" className="form-control" name="model" value={model} onChange={handleInputChange} placeholder="Model" />
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 mb-4">
                    <div data-mdb-input-init className="form-outline">
                      <input type="password" id="form3Example6" className="form-control" name="passwordConfirm" value={passwordConfirm} onChange={handleInputChange} placeholder="Confirm Password" />
                      <label className="form-label" htmlFor="form3Example6">Confirm Password</label>
                    </div>
                  </div>
                </div>
                <div>
