...
function ContactUs() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('/v1/contact/contact', formData);
                                ...
                                <form onSubmit={handleSubmit}>
                                    <div className="row gy-4 gy-xl-5 p-4 p-xl-5">
                                        <div className="col-12">
                                            ...
                                            <input type="text" className="form-control" id="fullname" name="fullname" required onChange={handleChange} />
                                        </div>
                                        ...
                                        <div className="col-12">
                                            ...
                                            <textarea className="form-control" id="message" name="message" rows="3" required onChange={handleChange}></textarea>
                                        </div>
                                        <div className="col-12">
                                            <div className="d-grid">
                                                <button className="btn btn-dark btn-lg" type="submit" onChange={handleSubmit}>Submit</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
