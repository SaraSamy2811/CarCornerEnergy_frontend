      ...
      <div class="container">
        <div class="row gy-4 gy-lg-0">
            ...
            <div class="row gy-4">
              <div class="col-12">
                <div class="card widget-card border-light shadow-sm">
                  <div class="card-header text-bg-dark">Welcome, Ethan Leo</div>
                  <div class="card-body"style={{backgroundColor: 'white'}}>
                    <div class="text-center mb-3">
                      <img src="./assets/img/profile/profile-img-1.jpg" class="img-fluid rounded-circle" alt="Luna John"/>
                    </div>
              ...
              <div class="col-12">
                <div class="card widget-card border-light shadow-sm">
                  <div class="card-header text-bg-dark">About Me</div>
                  <div class="card-body"style={{backgroundColor: 'white'}}>
              ...
              <div class="col-12">
                <div class="card widget-card border-light shadow-sm">
                  <div class="card-header text-bg-dark">Skills</div>
                  <div class="card-body"style={{backgroundColor: 'white'}}>
          ...
          <div class="col-12 col-lg-8 col-xl-9">
            <div class="card widget-card border-light shadow-sm">
              <div class="card-body p-4"style={{backgroundColor: 'white'}}>
                    ...
                    <form action="#!" class="row gy-3 gy-xxl-4">
                      <div class="col-12">
                        <div class="row gy-2">
                          ...
                          <div class="col-12">
                            <img src="./assets/img/profile/profile-img-1.jpg" class="img-fluid" alt="Luna John"/>
                          </div>
                          <div class="col-12">
